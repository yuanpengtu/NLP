...
def loadfile():
    ...
    filename = module_path + '/data/neg.csv'
    neg = pd.read_csv(filename, header=None, index_col=None)
    filename = module_path + '/data/pos.csv'
    pos = pd.read_csv(filename, header=None, index_col=None, error_bad_lines=False)
    filename = module_path + '/data/neutral.csv'
    neu = pd.read_csv(filename, header=None, index_col=None)
